        ...
        <div className="block overview-block" id="overview-block">
            <div className="overview-content">
                ...
                <div className="overview-text gradient-border-padded" id="overview-text">
                    <h3 className="text-main">Career++ will run from <em>12:00 PM to 3:00 PM</em> in the Donadeo Innovation Center for Engineering at the University of Alberta North Campus</h3>
                </div>
            </div>
        </div>
    );
